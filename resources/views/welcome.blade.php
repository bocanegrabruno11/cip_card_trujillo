...
<div class="contenedor-home">
    ...
    <aside class="menu-lateral">
        ...
        <a href="{{ route('institucion-arbitral') }}" class="item dorado"><i class="fas fa-gavel"></i> Arbitraje<span>Servicios</span></a>
        <a href="{{ route('junta-prevencion') }}" class="item dorado"><i class="fas fa-gavel"></i> Junta de Prevención y Resolución de Disputas<span>Servicios</span></a>
