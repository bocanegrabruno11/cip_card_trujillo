...
<head>
    ...
    <title>Gestión de Contenidos - CARD CD La Libertad</title>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer border-0 justify-content-center pb-4">
                <button type="button" class="btn btn-light px-4" data-bs-dismiss="modal" id="btnCancelarLogout">Cancelar</button>
                
                <form action="{{ route('logout') }}" method="POST" id="logoutForm">
                    @csrf
                    <button type="submit" class="btn btn-danger px-4 fw-bold" id="btnSubmitLogout">
                        <span id="textLogout">Salir</span>
                        <span id="spinnerLogout" class="d-none">
...
<script>
    document.getElementById('logoutForm').addEventListener('submit', function() {
        ...
        const btnSubmit = document.getElementById('btnSubmitLogout');
        const btnCancelar = document.getElementById('btnCancelarLogout');
        const text = document.getElementById('textLogout');
        const spinner = document.getElementById('spinnerLogout');

        // 2. Desactivar botones para evitar doble clic
        btnSubmit.disabled = true;
        btnCancelar.disabled = true;

        // 3. Feedback visual (Spinner)
