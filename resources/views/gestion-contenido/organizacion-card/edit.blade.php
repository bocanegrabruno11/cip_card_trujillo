    ...
    <form action="{{ route('organizacion-gestion.update', $miembro->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="grupo" class="form-select" required>
                                    ...
                                    @php
                                        $opciones = [
                                            'organo_direccion' => 'Órgano Directivo',
                                            'organo_decision' => 'Órgano Decisorio',
                                            'organo_gestion_secretaria_general' => 'Secretaría General',
                                            'organo_gestion_secretaria_arbitral' => 'Secretaría Arbitral',
                                            'organo_gestion_secretaria_tecnica' => 'Secretaría Técnica',
            ...
            <div class="col-md-4">
                ...
                <button type="submit" id="btnSubmit" class="btn btn-warning text-white w-100 btn-lg">ACTUALIZAR DATOS</button>
            </div>
        </div>
    </form>
</div>
