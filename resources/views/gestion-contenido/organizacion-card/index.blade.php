                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="grupo" class="form-select form-select-sm">
                            ...
                            <option value="organo_direccion" {{ request('grupo') == 'organo_direccion' ? 'selected' : '' }}>Órgano Directivo</option>
                            <option value="organo_decision" {{ request('grupo') == 'organo_decision' ? 'selected' : '' }}>Órgano Decisorio</option>
                            <option value="organo_gestion_secretaria_general" {{ request('grupo') == 'organo_gestion_secretaria_general' ? 'selected' : '' }}>Secretaría General</option>
                            <option value="organo_gestion_secretaria_arbitral" {{ request('grupo') == 'organo_gestion_secretaria_arbitral' ? 'selected' : '' }}>Secretaría Arbitral</option>
                            <option value="organo_gestion_secretaria_tecnica" {{ request('grupo') == 'organo_gestion_secretaria_tecnica' ? 'selected' : '' }}>Secretaría Técnica</option>
