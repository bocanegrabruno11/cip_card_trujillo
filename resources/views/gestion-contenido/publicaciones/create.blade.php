...
<div class="container-fluid">
    ...
    <form action="{{ route('publicaciones.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group mb-3">
                            <input type="file" name="imagen_principal" class="form-control" id="inputMainImg" accept=".jpg,.jpeg,.png" required>
                        </div>
                        <div class="mb-3">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-5 pb-5">
            <button type="submit" id="btnSubmit" class="btn btn-primary px-5 btn-lg shadow">
        ...
        <div class="card-body">
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <input type="file" name="galeria[INDEX][imagen]" class="form-control form-control-sm" accept=".jpg,.jpeg,.png" required>
