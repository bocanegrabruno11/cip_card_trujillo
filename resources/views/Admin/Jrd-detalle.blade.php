...
@section('title', 'Detalle de Arbitraje #' )
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="mb-0">
                        ...
                        Resolución de Contrato N° 123-2024
                    </h4>
                    <small>ID: #105</small>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td>Disputa por incumplimiento de plazos en la entrega de obra pública.</td>
                        </tr>
                        <tr>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h6 class="mb-0">RUC: 20100100100</h6>
                                </div>
        ...
        <div class="card-body">
            <div class="accordion" id="accordionProcesos">
                ...
                <div class="accordion-item mb-3 border">
                        ...
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true">
                            <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                <div>
                                    ...
                                    <strong>Validacion de Voucher</strong>
                                    <br>
                    ...
                    <div id="collapse1" class="accordion-collapse collapse show" data-bs-parent="#accordionProcesos">
                        <div class="accordion-body">
                            <h6 class="mb-3">
                                <i class="fas fa-align-left me-2"></i>Descripción
                            </h6>
                            <p class="text-muted">Verificación del pago por derecho de arbitraje.</p>
                            ...
                            <div class="list-group">
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-7">
                                            <strong>Voucher_Pago.pdf</strong>
                                            <br>
                                            <small class="text-muted">
                                                <i class="fas fa-calendar me-1"></i>
                                                Subido: 15/12/2025 11:05
                                            </small>
                                            <br>
                                            <small><span class="badge bg-secondary">PDF</span></small>
                                        </div>
                                        <div class="col-md-4 text-end">
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-7">
                                            <strong>Foto_Recibo.jpg</strong>
                                            <br>
                                            <small class="text-muted">
                                                <i class="fas fa-calendar me-1"></i>
                                                Subido: 15/12/2025 11:10
                                            </small>
                                            <br>
                                            <small><span class="badge bg-secondary">IMAGEN</span></small>
                                        </div>
                                        <div class="col-md-4 text-end">
                                            <button type="button" class="btn btn-sm btn-outline-danger me-2">
                                                <i class="fas fa-eye me-1"></i>Ver
                ...
                <div class="accordion-item mb-3 border">
                    <h2 class="accordion-header" id="heading2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false">
                            <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                <div>
                                    <i class="fas fa-file-alt text-primary me-2"></i>
                                    <strong>Designación de Árbitros</strong>
                                    <br>
                                    <small class="text-muted">
                                        <i class="fas fa-clock me-1"></i>
                                        Sin fecha
                    ...
                    <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#accordionProcesos">
                        <div class="accordion-body">
                            <h6 class="mb-3"><i class="fas fa-align-left me-2"></i>Descripción</h6>
                            <p class="text-muted">Sorteo y aceptación de árbitros.</p>
                            <hr>
