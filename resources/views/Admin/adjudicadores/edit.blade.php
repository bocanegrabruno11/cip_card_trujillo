...
@section('title', 'Editar Adjudicador')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-danger text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">
                            <i class="fas fa-user-edit me-2"></i> Editar Adjudicador
                        </h3>
                ...
                <div class="card-body">
                    ...
                    {{-- ✅ CORREGIDO: pasamos el ID explícitamente como string --}}
                    <form action="{{ route('adjudicadores.update', $adjudicador->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card card-outline card-primary shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('nombre', $adjudicador->nombre) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('apellidos', $adjudicador->apellidos) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('telefono', $adjudicador->telefono) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="correo">Correo de Contacto del Adjudicador</label>
                                            <input type="email"
                                                   class="form-control @error('correo') is-invalid @enderror"
                                                   id="correo" name="correo"
                                                   value="{{ old('correo', $adjudicador->correo) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('direccion', $adjudicador->direccion) }}"
