...
@section('title', 'Gestión de Etapas JPRD')
@section('page-title', 'Administración de Etapas JPRD')
    ...
    <div class="card shadow-lg mb-4 border-0 overflow-hidden">
        <div class="card-header bg-white border-bottom py-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-bold text-dark">Crear Nueva Etapa JPRD</h5>
                    <p class="mb-0 small text-muted">Registra las etapas del proceso de JPRD</p>
                </div>
            </div>
        </div>
        <div class="card-body pt-4">
            <form action="{{ route('Admin.jrd.etapas.store') }}" method="POST" class="row g-3 align-items-end">
                @csrf
                <div class="col-md-8">
                    ...
                    <small class="text-muted mt-2 d-block">
                        <i class="fas fa-info-circle me-1"></i>Ingrese un nombre descriptivo para la etapa del proceso JPRD
                    </small>
                </div>
                <div class="col-md-4">
        ...
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 fw-bold text-dark">Listado de Etapas JPRD</h5>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td>
                                <form action="{{ route('Admin.jrd.etapas.update', $etapa->id) }}" method="POST" class="d-flex gap-2 align-items-center">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="{{ route('Admin.jrd.etapas.toggle', $etapa->id) }}" 
                                    ...
                                    <form action="{{ route('Admin.jrd.etapas.destroy', $etapa->id) }}" method="POST" 
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="small text-muted mb-0">
                                Las etapas activas son las que estarán disponibles en el flujo del proceso JPRD.
