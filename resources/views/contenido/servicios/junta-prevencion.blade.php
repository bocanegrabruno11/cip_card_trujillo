...
@section('title', 'Junta de Prevención - CIP La Libertad')
...
<style>
    ...
    .doc-btn:hover { background-color: #ff5252; color: white; }
    .doc-btn i { font-size: 20px; margin-right: 15px; }

    .doc-meta {
        font-size: 12px; color: #666; font-style: italic; margin-top: 0px; margin-bottom: 25px; margin-left: 5px;
    }

    .empty-msg { color: #888; font-style: italic; margin-top: 10px; }
...
.btn-calc-red:hover {
    background-color: #B71C1C !important; /* Rojo más oscuro al pasar mouse */
        ...
        <div class="tabs-content">
            ...
            <div id="normativa" class="tab-pane">
                ...
                @forelse($docs as $doc)
                    ...
                    <div class="doc-meta">
                        Publicado el {{ $doc->fecha_publicacion->format('d/m/Y') }}
                        @if($doc->descripcion) | {{ Str::limit($doc->descripcion, 100) }} @endif
                    </div>
                @empty
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <h6 class="text-muted fw-bold mb-3 border-bottom pb-2">NORMATIVA VIGENTE</h6>
...
<script>
    function openCalculator(url) {
        // Abre una ventana de 500x700 centrada o ajustada
...
<script>
    function openTab(evt, tabName) {
        ...
        // 3. Mostrar el tab actual y activar el botón
