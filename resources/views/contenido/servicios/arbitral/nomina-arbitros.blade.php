...
<div class="custom-container" style="margin-bottom: 80px;">
    ...
    <div class="mb-4">
        <a href="{{ route('institucion-arbitral') }}" class="text-decoration-none" style="color: #AD2B2E; font-weight: bold;">
    ...
    <div class="arbitro-grid">
        @foreach($arbitrosNomina as $per)
            <div class="arbitro-card" onclick="verDetalle({{ json_encode($per) }})">
                ...
                <span class="role-badge">{{ $per->cargo ?? 'Árbitro' }}</span>
